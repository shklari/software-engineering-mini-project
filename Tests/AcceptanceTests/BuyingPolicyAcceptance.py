...
class TestUserBuyingPolicy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.store1 = self.service.create_store("shaioz")
    ...
    def test_age_policy_success(self):
        ...
        self.service.add_to_cart("shaioz", "item1", 1)
        self.assertTrue(self.service.buy_items([self.item1]).success)

    def test_age_policy_fail(self):
        self.item1.set_buying_policy(self.age_policy)
        self.service.login("young", "young")
        self.service.add_to_cart("shaioz", "item1", 1)
        self.assertFalse(self.service.buy_items([self.item1]).success)
...
class TestStoreBuyingPolicy(unittest.TestCase):
    ...
    def test_min_policy_success(self):
        ...
        self.service.login("good", "good")
        self.service.add_to_cart("shaioz", "item2", 5)
        self.assertTrue(self.service.buy_items([self.item1]).success)

    def test_min_policy_false(self):
        self.item1.set_buying_policy(self.min_item_policy)
        self.service.login("good", "good")
        self.service.add_to_cart("shaioz", "item1", 1)
        self.assertFalse(self.service.buy_items([self.item1]).success)
    ...
    def test_max_policy_success(self):
        self.item1.set_buying_policy(self.max_item_policy_good)
        self.service.login("good", "good")
        self.service.add_to_cart("shaioz", "item2", 5)
        self.assertTrue(self.service.buy_items([self.item1]).success)

    def test_max_policy_fail(self):
        self.item1.set_buying_policy(self.max_item_policy_bad)
        self.service.login("good", "good")
        self.service.add_to_cart("shaioz", "item2", 5)
        self.assertFalse(self.service.buy_items([self.item1]).success)
...
class TestItemBuyingPolicy(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.item1 = self.store1.value.search_item_by_name("item1")
        self.item2 = self.store1.value.search_item_by_name("item2")
        self.min_item_policy = MinQuantityItemPolicy(self.item2, 3)
        self.max_item_policy_bad = MaxQuantityItemPolicy("shaioz", 1)
        self.max_item_policy_good = MaxQuantityItemPolicy("shaioz", 5)
        self.service.logout()

    def test_min_policy_success(self):
        self.item1.set__buying_policy(self.min_item_policy)
        self.service.login("good", "good")
        self.service.add_to_cart("shaioz", "item2", 5)
        self.assertTrue(self.service.buy_items([self.item1]).success)
