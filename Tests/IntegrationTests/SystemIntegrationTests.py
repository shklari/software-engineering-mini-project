...
class TestUserActions(SystemIntegrationTests):
    def test_good_signup_login(self):
        self.assertTrue(self.system.sign_up('avokadosh', 'Aa12', 21, "").success)
    ...
    def test_bad_remove_user(self):
        self.assertTrue(self.system.sign_up('ava bash', '666', 21, "").success)
        self.assertTrue(self.system.sign_up('avokadosh', '9876', 21, "").success)
...
class TestStoreAction(SystemIntegrationTests):
    ...
    def test_good_add_owner_manager(self):
        self.assertTrue(self.system.sign_up('ava bash', '666', 21, "").success)
        self.assertTrue(self.system.sign_up('inbar', '9876', 21, "").success)
        self.assertTrue(self.system.sign_up('shklark', '6789', 21, "").success)
        self.assertTrue(self.system.login('ava bash', '666').success)
        self.assertTrue(self.system.create_store('avastore').success)
